...
public:
	...
	*/
	...
	//void BAPs::merge(BAPs *BAPs); //Compiler error for redundancy (gcc error: extra qualification)
	...
	*/
	...
	//void BAPs::setMask(bool maskValue); //Compiler error for redundancy (gcc error: extra qualification)
	...
	*/
	...
	//void BAPs::setMaskIfDiff(BAPs *baps); //Compiler error for redundancy (gcc error: extra qualification)
	...
	*/
	...
	//void BAPs::setMask(BAPs *baps); //Compiler error for redundancy (gcc error: extra qualification)
