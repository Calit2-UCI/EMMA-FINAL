...
public:
	...
	*/
	...
	//void FAP1::set(const FAP1 *f);//Compiler error for redundancy (gcc error: extra qualification)
	...
	*/
	void merge(FAP1 *f);
	//void FAP1::merge(FAP1 *f);//Compiler error for redundancy (gcc error: extra qualification)
	...
	*/
	int isVoid();
	//int FAP1::isVoid();//Compiler error for redundancy (gcc error: extra qualification)
	...
	*/
	bool isEqual(FAP1 *f);
	//bool FAP1::isEqual(FAP1 *f);//Compiler error for redundancy (gcc error: extra qualification)
	...
	*/
	void reset();
	//void FAP1::reset();//Compiler error for redundancy (gcc error: extra qualification)
};
