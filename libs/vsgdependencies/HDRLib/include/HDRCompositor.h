...
* @see		Readme.txt
*/
#ifndef __HDRCompositor_H__
#define __HDRCompositor_H__
...
public:
	...
	bool GetLumAdaptation(void) const { return m_LumAdaption; }
	void SetLumAdaptation(bool LumAdaptation) {	m_LumAdaption = LumAdaptation; Create(); }
